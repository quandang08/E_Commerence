            ...
            <div class="col-md-9">
                <div class="row pb-3">
                    ...
                    <div class="col-md-4">
                        <div class="card product-card">
                            <div class="product-image position-relative">
                                ...
                                @else
                                <img class="card-img-top" src="{{ asset('admin-assets/img/puppy.jpg') }}">
                                @endif
                                </a>
                    ...
                    <div class="col-md-12 pt-5">
                        <!-- phân trang cho danh sách sản phẩm và giữ lại các tham số truy vấn hiện tại trong URL khi di chuyển giữa các trang. -->
...
<script>
    $(document).ready(function() {
        ...
        function apply_filters() {
            // Thu thập các giá trị checkbox đã chọn
            var brands = [];
            ...
            // Tạo URL mới và điều hướng đến đó
            var url = '{{ url()->current() }}?';
