        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title">
                    <button type="button" onclick="window.location.href='{{ route('brands.index') }}'" class="btn btn-secondary btn-sm ml-2">Reset</button>
                    </button>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" onclick="deleteBrand({{ $brand->id }}, '{{ route('brands.delete' , $brand->id) }}')" class="text-danger w-4 h-4 mr-1">
...
@section('customJs')
<script>
function deleteBrand(brandId, deleteUrl) {
        Swal.fire({
            title: 'Are you sure?',
